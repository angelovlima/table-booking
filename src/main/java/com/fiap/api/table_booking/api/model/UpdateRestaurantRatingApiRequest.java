...
@Schema(description = "Objeto para editar avaliação do restaurante")
public record UpdateRestaurantRatingApiRequest(
        ...
        @Schema(description = "Número de estrelas", example = "4") Integer stars
) {
}
